...
export function renderTransactions(tasks, isFiltered = false) {
    const transactionContainer = document.querySelector(".transactions-all-container");
    ...
    tasks.forEach((task, index) => {
        ...
        const dateKey = taskDate.toDateString() === today.toDateString()
            ? "Today"
