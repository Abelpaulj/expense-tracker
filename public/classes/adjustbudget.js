...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const budgetInput = document.querySelector(".euro-input input");
    const saveButton = document.querySelector(".budget-btn");
    const deleteButton = document.querySelector(".budget-delete");
    ...
    const updatePlaceholder = (amount) => {
        if (budgetInput) {
