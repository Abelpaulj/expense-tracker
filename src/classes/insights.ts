import { loadTasksFromLocalStorage, saveTasksToLocalStorage } from "../index.js"
...
export function sendBudgetNotification(remainingBudget: number, totalBudget: number): void {
...
export function onTaskUpdated(): void {
  updateBudgetDisplay();
...
function updateBudgetProgress() {
  ...
  const circle = document.querySelector(".circle") as SVGPathElement | null;
  const percentageText = document.querySelector(".percentage") as SVGTextElement | null;
